  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="error-page">
        <h2 class="headline text-yellow text-alert"> 403</h2>
        <div class="error-content text-area">
          <div class="text-alert">
            <h3><i class="fa fa-warning text-yellow"></i> 해당 페이지에 접근할 수 없습니다.</h3>
            <p>
              <!-- <c:out value="${dp_name}"/> <c:out value="${e_name}"/>님의 [<c:out value="${e_role}"/>]권한으로
              해당 페이지를 <br> 접근할 수 없습니다. -->

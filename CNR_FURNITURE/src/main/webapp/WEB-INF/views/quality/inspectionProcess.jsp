...
<div class="content-wrapper">
   <!-- 검색 Form -->
   <form action="/M/quality/inspectionProcess" id="searchInspProcess" name="searchInspProcess" class="col-md-12" method="get">
...
<!-- 공정불량수정 모달 -->
<div class="modal fade" id="editModal" aria-labelledby="#update-ProcessInspection-ModalLabel" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-hidden="true">
  <div class="modal-dialog" role="document" style="min-width: 60%;">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <!-- modal-body -->
      <div class="modal-body inspection-modal-body">
         <form action="/inspectionProcess/update" id="updateInspProcessForm" name="updateInspProcessForm" class="col-md-12" >
            ...
            <div class="inspection-modal-board">
              ...
              <div class="col-sm-2 inspection-modal-name">공정명</div>
              <div class="col-sm-2 inspection-modal-text">
                <input type="text" class="col-sm-12 modal-input" id="editProcessName" name="processName"
                  value='<c:out value="${data.processName}"/>' autocomplete="off" readonly="readonly"/>
              </div><!-- /.공정명 -->
            </div><!-- /.수정행 1 -->
            <!-- 수정행 2 -->
            <div class="inspection-modal-board">
              ...
              <div class="col-sm-2 inspection-modal-name">설비번호</div>
              <div class="col-sm-2 inspection-modal-text">
                 <input type="text" class="col-sm-12 modal-input" id="editMachineID" name="machineID"
                    value='<c:out value="${data.machineID}"/>' autocomplete="off" readonly="readonly"/>
              </div><!-- /.설비번호 -->
              <!-- 단위 -->
              <div class="col-sm-2 inspection-modal-name">단위</div>

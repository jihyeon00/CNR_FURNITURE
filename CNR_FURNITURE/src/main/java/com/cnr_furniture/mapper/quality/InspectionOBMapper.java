...
@Mapper
public interface InspectionOBMapper {
  /* [출하불량현황] - 검색 및 현황 조회 ====================================================================================================== */
  /**
   * Desc: 검색창 - 제조LOT번호 - 조회
   */
  ...
  /**
   * Desc: 등록 모달창 - [품질검사 테이블] - [제품불량등록] 데이터 INSERT
   */
  void insertQualityInspection(InspOBInsertVO insertVO);

  /**
   * Desc: 등록 모달창 - [작업 테이블] - [제품불량등록] 데이터 UPDATE
   */
  void updateWork(InspOBInsertVO insertVO);

  /**
   * Desc: 등록 모달창 - [재고 테이블] - [제품불량등록] 데이터 UPDATE 또는 INSERT
   */
  void insertOrUpdateInventory(InspOBInsertVO insertVO);

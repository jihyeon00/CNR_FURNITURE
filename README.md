...
### 📁프로젝트 구현 내용
  - 가구를 생산하고 제조하는 회사가 가구를 생산하는 데에 필요한 정보들, 
### ⚙️ 개발환경 및 도구
  - `JAVA 17`
  - `JDK 17.0.2`
  - **IDE**: IntelliJ
...
|[이현주(팀원)](https://github.com/icanbewhatever)|<p align="center"><img src="https://avatars.githubusercontent.com/u/139785614?v=4" width="100"></p>|제품/자재 정보관리, BOM 관리|
